    ...
    <DrawerContentScrollView style={{backgroundColor: '#1d1e1f'}}>
      <View style={styles.menu}>
        ...
        <View style={styles.optionsContainer}>
          <TouchableOpacity
            style={[styles.option, getActiveStyle('MoviesStack')]}
            onPress={() => props.navigation.navigate('MoviesStack')}>
            <Text style={styles.textOption}>
              <Icon name="grid" size={30} color={colors.primary.color} />{' '}
              Gallery
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.option, getActiveStyle('Favorites')]}
